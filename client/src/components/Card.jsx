...
function Card(props) {
  ...
  return (
    <div className='min-h-[17rem] min-w-[12rem] drop-shadow-md bg-white rounded-md flex max-w-[17rem] gap-y-2 max-h-[19rem] flex-col items-center p-2 md:scale-100 scale-[97%] origin-top-left' onClick={()=>{setActPlant(props.Data)}}>
